...
class Device {
	...
	_updateVolume(instanceID, channel, callback) {
		...
		this.requestVolume(instanceID, channel, (error, xml2) => {
			...
			this._propertiesChanged(xml2, instanceID, props, false, "upnp.RenderingControl", null, callback);
		});
	}
	...
	_updateTransportInfo(instanceID, callback) {
		this.requestTransportInfo(instanceID, (error, xml2) => {
			...
			this._propertiesChanged(xml2, instanceID, TRANSPORT_INFOS_PROPS, false, "upnp.AVTransport", null, callback);
		});
	}
